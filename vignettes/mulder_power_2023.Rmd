...
lagged_effects <- matrix(c(0.20, 0.10, 0.15, 0.30), byrow = FALSE, ncol = 2)
# powRICLPM automatically computes Psi based on lagged_effects and within_cor
...
with_progress({
  out_preliminary <- powRICLPM(
    ...
    search_step = 100,
    time_points = c(3, 4, 5),
    intraclass_correlation = c(0.3, 0.5, 0.7),
    RI_cor = 0.35,
...
summary(out_preliminary, sample_size = 200, time_points = 3, intraclass_correlation = 0.3, reliability = 1)
