...
If you are unsure if you have specified the `lagged_effects` matrix as intended, you can use the `check_Phi()` function to give you a summary of how the lagged effects are interpreted. 
